...
public class UserSerivceImplTest {
    ...
    public void registerUser() {
        userService.registerUser(new User(null, "com/john", "666666","66663@qq.com"));
        userService.registerUser(new User(null, "jdsfsn", "6dsfds666","66fsdf63@qq.com"));
    }

    @Test
    public void login() {
        System.out.println(userService.login(new User(null, "com/john", "666666", null)));
    }

    @Test
    public void existsUsername() {
        if (userService.existsUsername("com/john")){
